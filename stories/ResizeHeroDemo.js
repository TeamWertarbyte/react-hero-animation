...
export default class ResizeHeroDemo extends Component {
  constructor (props) {
    super(props)
    this.state = { index: 0 }
  }
  ...
  render () {
    ...
    return (
      <HeroAnimationProvider>
        ...
        <Hero id='hero-1' show={index % 3 === 0} resize>
          <div style={{ background: '#cfc', width: 200, height: 100 }}>A</div>
        </Hero>

        <Hero id='hero-1' show={index % 3 === 1} resize>
          <div style={{ background: '#ccf', width: 400, height: 200 }}>B</div>
        </Hero>

        <Hero id='hero-1' show={index % 3 === 2} resize>
